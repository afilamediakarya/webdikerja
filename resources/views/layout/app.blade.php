										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('penilaian',['type' => 'skp'])}}" class="menu-link">
													...
													<span class="menu-text">Review SKP</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('penilaian',['type' => 'realisasi'])}}" class="menu-link">
													...
													<span class="menu-text">Review Realisasi</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('penilaian',['type' => 'perilaku'])}}" class="menu-link">
													...
													<span class="menu-text">Nilai Perilaku</span>
												</a>
											</li>
										</ul>
									</div>
										...
										<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex btn-lg px-2">
											...
											<div class="symbol symbol-40 symbol-light ml-4">
                                                <span class="symbol-label">
                                                    <img src="{{asset('media/svg/avatars/001-boy.svg')}}" class="h-60 align-self-end" alt="">
                                                </span>
                                            </div>
                                        </div>
									</div>
