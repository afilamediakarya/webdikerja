					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="nav nav-dark">
								...
								<a href="https://api.whatsapp.com/send/?phone=6281144411201&text=Hai+Afila%2C+Saya+ada+pertanyaan+tentang++aplikasi+dikerja&app_absent=0" target="_blank" class="nav-link pl-0 pr-0">Contact</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
