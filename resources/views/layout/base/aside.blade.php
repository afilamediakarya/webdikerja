        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                @if (Session::get('user.role') !== 'super_admin')
                    ...
                    <!-- <li class="menu-item menu-item-submenu {{ str_contains(Request::path(), 'skp') ? 'menu-item-active menu-item-open' : '' }}"
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{ url('skp/bulanan') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                    ...
                    <!-- <li class="menu-item {{ Request::path() == 'skp' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ url('/skp') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                ...
                <li class="menu-item {{ Request::path() == 'aktivitas' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    ...
                    <li class="menu-item menu-item-submenu {{ str_contains(Request::path(), 'penilaian') ? 'menu-item-active menu-item-open' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="svg-icon menu-icon">
                            ...
                            <span class="menu-text text-capitalize">Penilaian</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                    ...
                    <li class="menu-item menu-item-submenu {{ str_contains(Request::path(), 'laporan') ? 'menu-item-active menu-item-open' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                    ...
                    <li class="menu-item {{ Request::path() == 'bankom' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                ...
                @if (Session::get('user.role') != 'pegawai')
                    ...
                    @if (Session::get('user.role') == 'super_admin')
                        <li class="menu-item {{ Request::path() == '/dashboard/super_admin' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                    ...
                    @else
                        <li class="menu-item {{ Request::path() == '/dashboard/admin' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                    ...
                    <li class="menu-item menu-item-submenu {{ $path[0] == 'laporan' ? 'menu-item-open' : '' }}"
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                @if (Session::get('user.role') == 'super_admin')
                                    <li class="menu-item {{ $path[1] == 'Absen' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ url('/laporan/absen/super_admin') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                    ...
                    @if (Session::get('user.role') == 'super_admin')
                        <li class="menu-item {{ str_contains(Request::path(), 'jadwal') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                    ...
                    @else
                        <li class="menu-item {{ str_contains(Request::path(), 'kegiatan') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                    ...
                    <li class="menu-item {{ str_contains(Request::path(), 'informasi') ? 'menu-item-active menu-item-open' : '' }}"
                        aria-haspopup="true">
...
@endif
                    ...
                    @if (Session::get('user.role') == 'super_admin')
                        <li class="menu-item {{ str_contains(Request::path(), 'satker') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-submenu {{ str_contains(Request::path(), 'master') ? 'menu-item-active menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('master-aktivititas') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Master Aktivitas</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('master_harilibur') }}" class="menu-link">
                                            ...
                                            <span class="menu-text text-capitalize">Hari Libur</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="menu-item {{ str_contains(Request::path(), 'admin/admin') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
