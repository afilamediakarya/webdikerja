        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                @if (Session::get('user.role') !== 'super_admin')
                    <li class="menu-item {{ Request::path() == '/dashboard/pegawai' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                    ...
                    <li class="menu-item {{ $path[0] == 'skp' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ url('skp/tahunan') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="menu-text text-capitalize">Sasaran Kinerja</span>
                        </a>
                    </li>

            

                    <li class="menu-item menu-item-submenu {{ $path[0] == 'penilaian' ? 'menu-item-active menu-item-open' : '' }}"
                        ...
                        <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <span class="menu-text text-capitalize">Review</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                <li class="menu-item {{ $path[0] == 'penilaian' && $path[1] == 'skp' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('penilaian', ['type' => 'skp']) }}" class="menu-link">
                                ...
                                <li class="menu-item {{ $path[0] == 'penilaian' && $path[1] == 'realisasi' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('penilaian', ['type' => 'realisasi']) }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                    ...
                    <li class="menu-item {{ Request::path() == 'realisasi' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ url('/realisasi') }}" class="menu-link">
                            ...
                            <span class="menu-text text-capitalize">SKP Realisasi</span>
                        </a>
                    </li>
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item {{ $path[0] == 'laporan-pegawai' && $path[1] == 'skp' ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true">
                                    <a href="{{ url('laporan-pegawai/skp?type=pegawai') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                    ...
                    <!-- <li class="menu-item {{ $path[0] == 'bankom' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                ...
                @if (Session::get('user.role') != 'pegawai')
                    ...
                    @else
                        <li class="menu-item {{ $path[0] == 'dashboard' && $path[1] == 'admin' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <!-- @if (Session::get('user.role') == 'admin_opd')
                                    <li class="menu-item {{ $path[0] == 'laporan' && $path[1] == 'bankom' && $path[2] == 'admin' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    ...
                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'pegawai' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                    ...
                    {{-- @if (Session::get('user.role') == 'admin_opd')
                        <li class="menu-item menu-item-submenu {{ $path[0] == 'admin' && $path[1] == 'verifikasi' ? 'menu-item-active menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    @if (Session::get('user.role') == 'admin_opd')
                                        <li class="menu-item {{ $path[0] == 'verifikasi' && $path[1] == 'pendidikan-formal' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    ...
                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'jabatan' ? 'menu-item-active' : '' }}"
                        aria-haspopup="true">
                    ...
                    @if (Session::get('user.role') == 'super_admin')
                        ...
                        <li class="menu-item menu-item-submenu {{ $path[0] == 'admin' && $path[1] == 'master-aktivitas' ? 'menu-item-active menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                                ...
                                <span class="menu-text text-capitalize">Master Aktivitas</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'master-aktivitas' && $path[2] == 'kelompok-jabatan' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                    ...
                                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'master-aktivitas' && $path[2] == 'master-aktivitas' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('master-aktivitas') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                        ...
                        <li class="menu-item menu-item-submenu {{ $path[0] == 'admin' && $path[1] == 'satuan-kerja' ? 'menu-item-active menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <span class="menu-text text-capitalize">Satuan Kerja</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'satuan-kerja' && $path[2] == 'satker' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('satker') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Satuan Kerja</span>
                                        </a>
                                    </li>
                                    <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'satuan-kerja' && $path[2] == 'lokasi' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                        ...
                        <li class="menu-item {{ $path[0] == 'jadwal' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'hari-libur' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('master_harilibur') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text text-capitalize">Libur</span>
                            </a>
                        </li>
                    @endif

                    <!-- <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'informasi' ? 'menu-item-active menu-item-open' : '' }}"
                        aria-haspopup="true">
                    ...
                    @if (Session::get('user.role') == 'super_admin')
                        ...
                        <li class="menu-item menu-item-submenu {{ $path[0] == 'admin' && $path[1] == 'master' ? 'menu-item-active menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                                ...
                                <span class="menu-text text-capitalize">Master</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <!-- <li class="menu-item {{ $path[0] == 'master' && $path[1] == 'faq' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                    ...
                                    <li class="menu-item  {{ $path[0] == 'admin' && $path[1] == 'master' && $path[2] == 'satuan' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('satuan') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text text-capitalize">satuan</span>
                                        </a>
                                    </li>
<!-- 
                                    <li class="menu-item  {{ $path[0] == 'maintanence' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('aborts') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text text-capitalize">perilaku</span>
                                        </a>
                                    </li> -->
                        ...
                        <li class="menu-item {{ $path[0] == 'admin' && $path[1] == 'admin' ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
