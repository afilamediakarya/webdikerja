    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            @if(Session::get('user.role') !== 'super_admin')
                ...
                <li class="menu-item menu-item-submenu {{str_contains(Request::path(), 'skp') ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route('penilaian',['type' => 'skp'])}}" class="menu-link">
                                    ...
                                    <span class="menu-text text-capitalize">Review SKP</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-submenu {{str_contains(Request::path(), 'laporan') ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            @if (Session::get('user.role') <> 'pegawai')
                ...
                @if(Session::get('user.role') == 'super_admin')
                <li class="menu-item {{ Request::path() == '/dashboard/super_admin' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item {{str_contains(Request::path(), 'absen') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-submenu {{str_contains(Request::path(), 'master') ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
