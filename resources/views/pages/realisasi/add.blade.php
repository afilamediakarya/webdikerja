        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Tambah Realisasi SKP</h3>
                </div>
                <div class="card-body">
                    <!--begin::Form-->
                        ...
                        <div class="row">
                            @if ($rencana !== 'undefined')
                                <div class="form-group col-6">
                                    ...
                                    <textarea class="form-control form-control-solid" readonly="readonly" id="exampleTextarea" rows="4">{{ $rencana }}</textarea>
                                </div>
                            @endif
                            @if ($rencana !== 'undefined')
                                <div class="form-group col-6">
                            ...
                            <label for="exampleTextarea">Rencana Kinerja Pegawai
                                <span class="text-danger">*</span></label>
                            <textarea class="form-control form-control-solid" readonly="readonly" id="exampleTextarea" rows="4">{{ $data['rencana_kerja'] }}</textarea>
                        </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="exampleTextarea">Indikator Kinerja Individu
                                    <span class="text-danger">*</span></label>
                                <textarea class="form-control form-control-solid" id="exampleTextarea" rows="6" readonly>{{ $value['iki'] }}</textarea>
                            </div>
                            <div class="col-6">
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        @foreach ($value['target_skp'] as $f => $b)
                                            @if ($b['bulan'] == $bulan)
                                                <label>Target </label>
                                                <input type="text" readonly value="{{ $b['target'] }}"
                                    ...
                                    <div class="form-group col-6">
                                        <label>Satuan </label>
                                        <input type="text" readonly value="{{ $value['satuan'] }}"
                                            class="form-control form-control-solid" placeholder="">
                                    </div>
                                    <div class="form-group col-6">
                                            ...
                                            @for ($i = 0; $i < count($value['realisasi_skp']); $i++)
                                                @if ($bulan != 0)
                                                    @if ($value['realisasi_skp'][$i]['bulan'] == $bulan)
                                                        ...
                                                        <input type="number" id="tes" class="form-control"
                                                            name="realisasi[{{ $key }}]"
                                                            value="{{ $value['realisasi_skp'][$i]['realisasi_bulanan'] }}"
                                                            placeholder="">
                                                    @endif
                                                @else
                                                    <div class="mb-10">
                                                        <label class="form-label">Realisasi bulan ke
                                                            {{ $i + 1 }}</label>
                                                        <input type="text" id="tes" class="form-control"
                                                            name="realisasi[{{ $key }}][{{ $i }}]"
                                                            value="{{ $value['realisasi_skp'][$i]['realisasi_bulanan'] }}"
                                                            placeholder="">
                                                    </div>
                                                @endif
                                        ...
                                        @else
                                            <input type="text" id="tes" class="form-control"
                                                name="realisasi[{{ $key }}]" placeholder="">
                                        @endif

                                        <input type="hidden" name="id_aspek_skp[{{ $key }}]"
                                            value="{{ $value['id'] }}">
                                    </div>
                                </div>
                            </div>
