...
@section('side-form')
        <div id="side_form" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0" id="title">Tambah Aktivitas<h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
                <form class="form" id="createForm">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid" type="text" name="aktivitas"/>
                        <small class="text-danger" id="aktivitas"></small>
                    </div>

                    <div class="form-group">
                        <label>Kelompok Jabatan</label>
                        <select class="form-control form-control-solid" type="text" name="kelompok_jabatan">
                            <option selected disabled> Pilih Kelompok Jabatan </option>
                            @foreach($kelompokJabatan as $val)
                                <option value="{{$val['id']}}">{{$val['value']}}</option>
                            @endforeach
                        </select>
                        <small class="text-danger" id="kelompok_jabatan"></small>
                    </div>

                    <div class="form-group">
                        <label>Satuan</label>
                        <select class="form-control form-control-solid" type="text" name="satuan">
                            <option selected disabled> Pilih Kelompok Jabatan </option>
                            @foreach($satuan as $vals)
                                <option value="{{$vals['value']}}">{{$vals['value']}}</option>
                            @endforeach
                        </select>
                        <small class="text-danger" id="satuan"></small>
                    </div>
                    ...
                    <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <div class="radio-inline">
                                    <label class="radio">
                                        <input type="radio" value="umum" name="jenis">
                                        <span></span>Umum</label>
                                    <label class="radio">
                                        <input type="radio" value="khusus" name="jenis">
                                        <span></span>Khusus</label>
                                </div>
                                <small class="text-danger" id="jenis"></small>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Waktu</label>
                                <input type="number" class="form-control form-control-solid" name="waktu">
                                <small class="text-danger" id="waktu"></small>
                            </div>
                    </div>
                ...
                columnDefs: [
                    {
                        ...
                        render : function (data) {
                            console.log(data);
                            let kelompok_jabatan = '';
                            data !== null ? kelompok_jabatan = data.kelompok : kelompok_jabatan = '-';
                    ...
                    success: function(data){
                      if(data.success){
                        ...
                        $.each(res, function( key, value ) {
                            ...
                            }else if(key == 'kelompok_jabatan'){
                                let vls = '';
                                value !== null ? vls = value.id : vls = '';
                                $("select[name='"+key+"']").val(vls);
                            }else{
