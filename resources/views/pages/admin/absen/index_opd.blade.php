        ...
        <div id="side_form" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
                <form class="form" id="createForm">
                  ...
                  <input type="hidden" name="satuan_kerja" value="{{$satker}}">
    ...
    $(document).on('click','#side_form_open', function (e) {
        ...
        function datatable_() {
            ...
            $('#kt_absen').DataTable({
                ...
                order: [[0, 'asc']],
                processing:true,
                ajax: '/admin/absen/datatable?satuan_kerja='+satker+'&tanggal='+tanggal+'&valid='+valid_+'&status='+status_,
                columns : [
                    { 
                    data : null, 
        ...
        $(document).on('click', '.button-update', function(){
         ...
         function satuanKerjaChange(params) {
        
            $.ajax({
                url : '/admin/axios/pegawai/'+satker,
                method : 'GET',
                success : function (res) {
