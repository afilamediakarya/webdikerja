        ...
        <div class="container">
                                ...
                                <select class="form-control form-control-solid" name="atasan">
                                    ...
                                    @foreach ($atasan as $item)
                                        <option value="{{ $item['id'] }}"
                                            {{ Session::has('atasan') ? (Session::get('atasan.id') == $item['id'] ? 'selected' : '') : '' }}>
                                            {{ $item['value'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        value="{{ $data_['tempat_lahir'] }}" name="tempat_lahir">
                                    <span class="invalid-feedback"></span>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control form-control-solid" readonly
                                            name="tanggal_lahir" value="{{ $data_['tanggal_lahir'] }}" id="tgl_lahir" />
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select name="id_satuan_kerja" class="form-control form-control-solid">
                                        ...
                                        @foreach ($dinas as $item)
                                            <option value="{{ $item['id'] }}"
                                                {{ $data_['id_satuan_kerja'] == $item['id'] ? 'selected' : '' }}>
                                    ...
                                    <select name="golongan" class="form-control form-control-solid">
                                        ...
                                        @foreach ($pangkat as $item)
                                            <option value="{{ $item['value'] }}"
                                                {{ $data_['golongan'] ? ($data_['golongan'] == $item['value'] ? 'selected' : '') : '' }}>
                                                {{ $item['value'] }}</option>
                                        @endforeach
                                    </select>
                                    <span class="invalid-feedback"></span>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control form-control-solid" readonly
                                            value="{{ $data_['tmt_golongan'] }}" id="tmt_gol" name="tmt_golongan" />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar"></i>
                                            </span>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control form-control-solid" readonly
                                            value="{{ $data_['tmt_pegawai'] }}" name="tmt_pegawai" id="tmt_peg" />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar"></i>
                                            </span>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control form-control-solid" name="jenis_kelamin">
                                        <option value="Laki-Laki"
                                            {{ $data_['jenis_kelamin'] ? ($data_['jenis_kelamin'] == 'Laki-Laki' ? 'selected' : '') : '' }}>
                                            Laki-Laki</option>
                                        <option value="Perempuan"
                                            {{ $data_['jenis_kelamin'] ? ($data_['jenis_kelamin'] == 'Perempuan' ? 'selected' : '') : '' }}>
                                            Perempuan</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select name="agama" class="form-control form-control-solid">
                                        @foreach ($agama as $item)
                                            <option value="{{ $item['value'] }}"
                                                {{ $data_['agama'] ? ($data_['agama'] == $item['value'] ? 'selected' : '') : '' }}>
                                                {{ $item['value'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select name="status_perkawinan" class="form-control form-control-solid">
                                        @foreach ($status_kawin as $item)
                                            <option
                                                value="{{ $item['value'] }} {{ $data_['status_perkawinan'] ? ($data_['status_perkawinan'] == $item['value'] ? 'selected' : '') : '' }}">
                                                {{ $item['value'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="pendidikan" class="form-control form-control-solid">
                                        @foreach ($pendidikan as $item)
                                            <option value="{{ $item['value'] }}"
                                                {{ $data_['pendidikan'] ? ($data_['pendidikan'] == $item['value'] ? 'selected' : '') : '' }}>
                                                {{ $item['value'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        value="{{ $data_['lulus_pendidikan'] }}" name="lulus_pendidikan">
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        value="{{ $data_['pendidikan_struktural'] }}" name="pendidikan_struktural">
                                </div>
                                <div class="form-group col-6">
                                    <label>Tahun Lulus Pendidikan Struktural</label>
                                    <input type="text" class="form-control form-control-solid"
                                        value="{{ $data_['lulus_pendidikan_struktural'] }}"
                                        name="lulus_pendidikan_struktural">
                                </div>
                                ...
                                <div class="form-group col-6">
                                    <label>Jurusan</label>
                                    <input type="text" class="form-control form-control-solid"
                                        value="{{ $data_['jurusan'] }}" name="jurusan">
                                </div>
                            </div>
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <button id="change_password" class="btn btn-sm btn-primary align-self-center"><i
                            class="flaticon2-pen"></i>Ganti Password</button>
                </div>
                <div class="card-body">
