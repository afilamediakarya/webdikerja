                    ...
                    <form class="form" id="skp-form">
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio">
                                    <input type="radio" value="utama" @if ($data['jenis'] == 'utama') checked @endif
                                        name="jenis_kinerja" />
                                    <span></span>Utama</label>
                                <label class="radio">
                                    <input type="radio" value="tambahan" @if ($data['jenis'] == 'tambahan') checked @endif
                                        name="jenis_kinerja" />
                                    ...
                                    <select class="form-control" type="text" name="sasaran_kinerja" id="sasaran_kinerja">
                                        ...
                                        @foreach ($sasaran_kinerja_atasan as $key => $value)
                                            <option value="{{ $value['id'] }}"
                                                @if ($data['id_skp_atasan'] == $value['id']) selected @endif>{{ $value['value'] }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        @if ($level == 1 || $level == 2)
                            <button type="button" id="add_content_iki" class="btn btn-info btn-sm mb-5"> <i
                        ...
                        @foreach ($data['aspek_skp'] as $key => $value)
                            ...
                            <input type="hidden" value="{{ $value['target_skp'][0]['id'] }}"
                                name="id_target[{{ $key }}]">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label for="indikator_kerja_individu_{{ $key }}">Indikator Kerja Individu
                                        </label>
                                        <textarea class="form-control" name="indikator_kerja_individu[{{ $key }}]"
                                            id="indikator_kerja_individu_{{ $key }}" rows="5">{{ $value['iki'] }}</textarea>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $value['satuan'] }}"
                                            name="satuan[{{ $key }}]">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $value['target_skp'][0]['target'] }}"
                                            name="target[{{ $key }}]" id="target">
...
@section('script')
    ...
    <script>
        $(function() {
            ...
            let typeSkp = $('input[name=type_skp]').val();
            if (typeSkp == 'kepala') {
                $('#sasaran_').hide();
                $('#sasaran_kinerja').val(null).trigger('change');
            }
